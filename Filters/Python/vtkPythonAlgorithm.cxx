...
#define GetMethod(var, obj, method, failValue)         \
  if (!obj)                                            \
    {                                                  \
    return failValue;                                  \
    }                                                  \
...
{
  PyObject* cls = vtkPythonUtil::FindNearestBaseClass(obj);
  return PyVTKObject_New(cls, NULL, obj);
}
...
void vtkPythonAlgorithm::SetPythonObject(PyObject* obj)
{
  ...
  GetMethod(method, this->Object, mname, /* no return */)
                                       ...
                                       vtkInformationVector* outInfo)
{
  ...
  GetMethod(method, this->Object, mname, 0)
